...
BOT_TOKEN = '8999903200:AAEYyOJSPqRjL0yoPck6Rb_IV3OCto09SJg'
ADMIN_ID = [6601184733]
...
def get_main_menu_keyboard(user_id=None):
    buttons = [
        ...
        [Button.url(" Cʜᴀɴɴᴇʟ", "https://t.me/Palautog_company", style="success", icon=5445408306669582934)]
    ]
...
💡 Made by @Xyoshy"""
    ...
    filename = f"yoshx{timestamp}.txt"
...
▸ Sʜᴏᴘɪғʏ
━━━━━━━━━━━━━━━━━
<code>/cc</code> · <code>/mstxt</code> · <code>/redeem</code>
━━━━━━━━━━━━━━━━━
...
├─ <code>/mstxtproxy ᴘʀᴏxʏ</code> → Cʜᴇᴄᴋ sɪɴɢʟᴇ ᴘʀᴏxʏ
...
@bot.on(events.NewMessage(pattern=r'/mstxtproxy\s+'))
async def check_single_proxy(event):
    ...
    if not proxy:
        await event.reply(premium_emoji("❌ Usᴀɢᴇ: <code>/mstxtproxy ɪᴘ:ᴘᴏʀᴛ:ᴜsᴇʀ:ᴘᴀss</code>"), parse_mode='html')
        return
